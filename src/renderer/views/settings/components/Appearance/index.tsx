    ...
    <Row>
      ...
      <Control>
        ...
        >
          ...
          <Dropdown.Item value="quantum-blue">Blue</Dropdown.Item>
          <Dropdown.Item value="quantum-lavender">Lavender</Dropdown.Item>
          <Dropdown.Item value="quantum-amoled">Amoled</Dropdown.Item>
        </Dropdown>
      </Control>
    </Row>
  );
