...
const themeset = (mode: string) => {
  ...
  if (theme == 'Light') {
    ...
    store.settings.theme = 'quantum-blue';
    store.settings.themeAuto = false;
    store.save();
    ...
    store.settings.theme = 'quantum-lavender';
    store.settings.themeAuto = false;
    store.save();
  }
};
  ...
  return (
    <ThemeProvider theme={{ ...store.theme }} style={{ position: 'relative' }}>
      ...
      <StyledSection className="banner1">
        <Description>Welcome to quantum!</Description>
      ...
      <StyledSection className="banner5">
        ...
        >
          For maximum privacy, set quantum as your default browser!
        </Description>
        <div
          style={{
            display: 'flex',
